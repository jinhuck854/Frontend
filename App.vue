...
<template> <!-- html이랑 비슷함 !-->
  ...
  <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://github.com/jinhuck854/Frontend/assets/121598818/6b77d068-1cfd-4679-aade-fa1aed565fa6" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="https://github.com/jinhuck854/Frontend/assets/121598818/f93fdfa1-5987-4e9d-a496-ddeceddc5e01" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="https://github.com/jinhuck854/Frontend/assets/121598818/0585a0cb-47b9-45ef-b436-3bb0bb759d23" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <nav class="navbar bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand">Search Address</a>
  ...
  <!-- Blog : Router 사용 <List :blogs="blogs"/> -->
  ...
  <Card style="float:center;" class="rounded mx-auto d-block" @openModal="is_open=true;
